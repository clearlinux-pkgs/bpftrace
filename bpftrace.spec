...
Version  : 0.9.3
Release  : 9
URL      : https://github.com/iovisor/bpftrace/archive/v0.9.3/bpftrace-0.9.3.tar.gz
Source0  : https://github.com/iovisor/bpftrace/archive/v0.9.3/bpftrace-0.9.3.tar.gz
...
%prep
%setup -q -n bpftrace-0.9.3
cd %{_builddir}/bpftrace-0.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574446687
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/bpftrace-0.9.3/LICENSE %{buildroot}/usr/share/package-licenses/bpftrace/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build
%make_install
popd
