...
Version  : 0.19.1
Release  : 24
URL      : https://github.com/iovisor/bpftrace/archive/v0.19.1/bpftrace-0.19.1.tar.gz
Source0  : https://github.com/iovisor/bpftrace/archive/v0.19.1/bpftrace-0.19.1.tar.gz
...
%prep
%setup -q -n bpftrace-0.19.1
cd %{_builddir}/bpftrace-0.19.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701937998
mkdir -p clr-build
pushd clr-build
